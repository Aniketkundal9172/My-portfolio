...
# Hero Section
st.markdown("""
    <div style='text-align: center; padding: 4rem 1rem; background: linear-gradient(to bottom right, rgba(99, 102, 241, 0.8), rgba(59, 130, 246, 0.8)), url("YOUR_BACKGROUND_IMAGE_URL_HERE"); background-size: cover; background-position: center; color: white; border-radius: 20px;'>
